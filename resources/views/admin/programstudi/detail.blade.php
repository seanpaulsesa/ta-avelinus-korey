                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <p>{{ $data->fakultas->kampus->nama_kampus ?? '' }}</p>
                            </div>

                            <!-- Nama Fakultas -->
                            <div class="form-group">
                                <label for="nama_fakultas">Fakultas</label>
                                <p>{{ $data->fakultas->nama_fakultas ?? '' }}</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <!-- Tombol Ubah -->
                                <a href="{{ route('admin.programstudi.edit', $data->id) }}" class="btn btn-dark">
                                ...
                                <!-- Tombol Kembali -->
                                <a href="{{ auth()->user()->hasRole('admin') ? route('admin.programstudi.index') : route('pimpinan.programstudi.index') }}" class="btn">
